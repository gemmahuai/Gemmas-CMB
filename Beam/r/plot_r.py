...
if (len(sys.argv)!=3):
    ...
    # ex. python plot_r.py data_r.csv amp
    sys.exit()
filename = str(sys.argv[1])
option = str(sys.argv[2])
(amp, noise_norm, r, RMS_real) = np.loadtxt('/home/gemma/Beam/r/{}'.format(filename), unpack=True, usecols=(0,1,3,5))
...
#sp = interp.InterpolatedUnivariateSpline()
...
#plt.show()
plt.savefig('/home/gemma/Beam/r/fig_{}_r.png'.format(option))
