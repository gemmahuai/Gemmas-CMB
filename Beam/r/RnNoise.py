...
###         + a text file containing error amp, normalized noise, ell vectors, r, and leakage power spectra
...
with open('/home/gemma/Beam/r/R_noise_{}_r.csv'.format(option), 'w') as file:
